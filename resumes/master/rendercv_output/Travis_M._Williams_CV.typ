...
#one-col-entry(content: [#bullet-entry[Building personal computers. Aside from the joy of assembling a complex machine and getting it to work, I've found it helps me to understand computer systems from a bottom-up perspective. I believe this provides directly relevant experience for the technical aspects of my profession.]])
#v(design-entries-vertical-space-between-entries)
